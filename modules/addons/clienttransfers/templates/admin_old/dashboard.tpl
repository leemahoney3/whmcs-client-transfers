...
<div class="ct-container">
  ...
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="transfers-pending">
        <table class="table table-striped" id="pendingTransfersTable">
            ...
            <tbody>
                {if count($transfers.pendingTransfers) eq 0}
                    <tr>
                        <td colspan="6"><p class="text-center" style="padding-top: 5px;">No records found</p></td>
                    </tr>
                {else}
        ...
        {{$transfers.pendingTransfersLinks}}
    </div>
    <div role="tabpanel" class="tab-pane" id="transfers-completed">
        ...
        {{$transfers.completedTransfersLinks}}
    </div>
    <div role="tabpanel" class="tab-pane" id="transfers-denied">
        ...
        {{$transfers.deniedTransfersLinks}}
    </div>
    <div role="tabpanel" class="tab-pane" id="transfers-cancelled">
        ...
        {{$transfers.cancelledTransfersLinks}}
    </div>
  </div>
</div>
{/block}
...
{block "scripts"}
    ...
    <script>
        $(document).ready(function () {
            ...
            {if $smarty.get.tp}$('a[href="#transfers-pending"]').tab('show');{/if}
            {if $smarty.get.tc}$('a[href="#transfers-completed"]').tab('show');{/if}
            {if $smarty.get.td}$('a[href="#transfers-denied"]').tab('show');{/if}
            {if $smarty.get.tca}$('a[href="#transfers-cancelled"]').tab('show');{/if}
